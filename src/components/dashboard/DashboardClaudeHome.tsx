      ...
      <div className="flex w-full max-w-2xl flex-col items-center gap-8">
        ...
        <div className="w-full text-center">
          ...
          <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
            С чего начнём? Напиши вопрос ниже — откроется чат с выбранным предметом.
          </p>
        </div>

        <div className="w-full rounded-2xl border border-zinc-200/90 bg-white/80 p-4 shadow-sm backdrop-blur-sm dark:border-zinc-700/80 dark:bg-zinc-950/60 sm:p-5">
          <ChatInput onSend={handleSend} disabled={submitting} />
        </div>

        <div className="flex w-full flex-col gap-2">
          <div className="text-center text-xs font-medium uppercase tracking-wide text-zinc-500 dark:text-zinc-400">
            Предмет
          </div>
